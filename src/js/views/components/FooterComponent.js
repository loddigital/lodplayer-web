export const getFooterHTML = () => {
    return `
    <footer class="bg-[#030712] border-t border-white/12 pt-15 pb-10 text-[0.95rem] text-textMuted mt-auto">
        <div class="max-w-300 mx-auto px-8 relative grid grid-cols-1 md:grid-cols-[1.5fr_1fr_1fr] gap-12 mb-10">
            ...
            <div>
                <h4 class="font-outfit text-[1.05rem] font-semibold text-white mb-5">Quick Links</h4>
            ...
            <div>
                <h4 class="font-outfit text-[1.05rem] font-semibold text-white mb-5">Support & Contact</h4>
                <div class="flex flex-col gap-2.5">
                    <div class="flex items-center gap-2.5 text-[0.9rem]">
                        <svg viewBox="0 0 24 24" class="w-4 h-4 fill-textMuted"><path d="M20,4H4C2.89,4 2,4.89 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V6C22,4.89 21.1,4 20,4M20,8L12,13L4,8V6L12,11L20,6V8Z"/></svg>
