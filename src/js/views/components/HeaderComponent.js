    ...
    const navLinks = isHome 
        ? `<a href="#features" class="text-[0.95rem] font-medium text-textMuted hover:text-white transition-all hidden md:block">Features</a>
           ...
           <div class="relative group ml-2">
               <button aria-label="Language Selector" class="flex items-center justify-center text-[0.85rem] font-medium text-textMuted hover:text-white transition-all bg-white/5 border border-white/10 px-3 py-1.5 rounded-lg cursor-pointer h-9 w-9">
                   <svg viewBox="0 0 24 24" class="w-4 h-4 fill-current" aria-hidden="true"><path d="M12.87,15.07L10.33,12.56L10.36,12.53C12.1,10.59 13.34,8.36 14.07,6H17V4H10V2H8V4H1V6H12.17C11.5,7.92 10.44,9.75 9,11.35C8.07,10.32 7.3,9.19 6.69,8H4.69C5.42,9.63 6.42,11.17 7.67,12.56L2.58,17.58L4,19L9,14L12.11,17.11L12.87,15.07M18.5,10H16.5L12,22H14L15.12,19H19.87L21,22H23L18.5,10M15.88,17L17.5,12.67L19.12,17H15.88Z"/></svg>
               </button>
